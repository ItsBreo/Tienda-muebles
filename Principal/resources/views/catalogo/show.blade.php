...
@section('title', $categoria ? $categoria['name'] : 'Todos los Muebles')
        ...
        @forelse ($muebles as $mueble)
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm border-0">
                    <img src="{{ env('API_FURNITURE_URL') }}/{{ $mueble['main_image'] }}" class="card-img-top"
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="{{ route('muebles.show', ['id' => $mueble['id'], 'sesionId' => $activeSesionId]) }}" class="btn btn-primary w-100 mt-auto">
                            Ver Detalle
                        </a>
                    </div>
                </div>
