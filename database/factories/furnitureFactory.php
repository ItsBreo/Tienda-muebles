...
class furnitureFactory extends Factory
{
    ...
    {
        return [
            'categoryId' => Category::inRandomOrder()->first()->id, // Eleccion aleatoria de id de categorias
            ...
            'mainColor' => $this->faker->safeColorName, // Ejemplo: 'blue', 'brown', 'maroon'
            ...
            'isSalient' => $this->faker->boolean(20), // 20% de probabilidad de ser "Destacado" (TRUE)
        ];
    }
